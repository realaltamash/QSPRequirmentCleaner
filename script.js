...
function format(r, includeExtra) {
  ...
  const mastersStreamOut = r.mastersStream ? abbreviate(r.mastersStream, STREAM_ABBR_RE) : '';
  if (mastersStreamOut) lines.push(`Masters Stream : ${mastersStreamOut}`);
